...
Public Class FrmSMGE_3222M_ActPowerData
    ...
    Private Sub ButtonRecord_Click(sender As Object, e As EventArgs) Handles ButtonRecord.Click
        If ButtonRecord.Text = "Start Recording" Then
            ...
            DataGridViewActPower.Rows.Clear()
            ChartPowerRec.Series("Series1").Points.Clear()
    ...
    Private Sub CmdBack_Click(sender As Object, e As EventArgs) Handles CmdBack.Click
        DataGridViewActPower.Rows.Clear()
        ChartPowerRec.Series("Series1").Points.Clear()
        ChartPowerRec.Series("Series2").Points.Clear()
        ChartPowerRec.Series("Series3").Points.Clear()
        ChartPowerRec.Series("Series4").Points.Clear()
    ...
    Private Sub CmdExportToExcel_Click(sender As Object, e As EventArgs) Handles CmdExportToExcel.Click
        Try
            If DataGridViewActPower.Rows.Count > 0 Then
                ...
                If result = DialogResult.OK Then
                    ...
                    Dim multiselect As Boolean = DataGridViewActPower.MultiSelect
                    DataGridViewActPower.MultiSelect = True
                    DataGridViewActPower.SelectAll()
                    DataGridViewActPower.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableAlwaysIncludeHeaderText
                    Clipboard.SetDataObject(DataGridViewActPower.GetClipboardContent())
                    Dim results = System.Convert.ToString(Clipboard.GetData(DataFormats.Text))
                    DataGridViewActPower.ClearSelection()
                    DataGridViewActPower.MultiSelect = multiselect
