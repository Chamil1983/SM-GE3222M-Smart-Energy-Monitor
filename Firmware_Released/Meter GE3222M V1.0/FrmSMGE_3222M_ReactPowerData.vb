...
Public Class FrmSMGE_3222M_ReactPowerData
    ...
    Private Sub ButtonRecord_Click(sender As Object, e As EventArgs) Handles ButtonRecord.Click
        If ButtonRecord.Text = "Start Recording" Then
            ...
            DataGridViewReacPower.Rows.Clear()
            ChartReacPowerRec.Series("Series1").Points.Clear()
    ...
    Private Sub CmdBack_Click(sender As Object, e As EventArgs) Handles CmdBack.Click
        DataGridViewReacPower.Rows.Clear()
        ChartReacPowerRec.Series("Series1").Points.Clear()
        ChartReacPowerRec.Series("Series2").Points.Clear()
        ChartReacPowerRec.Series("Series3").Points.Clear()
        ChartReacPowerRec.Series("Series4").Points.Clear()
    ...
    Private Sub CmdExportToExcel_Click(sender As Object, e As EventArgs) Handles CmdExportToExcel.Click
        Try
            If DataGridViewReacPower.Rows.Count > 0 Then
                ...
                If result = DialogResult.OK Then
                    ...
                    Dim multiselect As Boolean = DataGridViewReacPower.MultiSelect
                    DataGridViewReacPower.MultiSelect = True
                    DataGridViewReacPower.SelectAll()
                    DataGridViewReacPower.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableAlwaysIncludeHeaderText
                    Clipboard.SetDataObject(DataGridViewReacPower.GetClipboardContent())
                    Dim results = System.Convert.ToString(Clipboard.GetData(DataFormats.Text))
                    DataGridViewReacPower.ClearSelection()
                    DataGridViewReacPower.MultiSelect = multiselect
