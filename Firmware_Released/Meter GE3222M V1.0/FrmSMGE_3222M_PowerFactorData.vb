...
Public Class FrmSMGE_3222M_PowerFactorData
    ...
    Private Sub ButtonRecord_Click(sender As Object, e As EventArgs) Handles ButtonRecord.Click
        If ButtonRecord.Text = "Start Recording" Then
            ...
            DataGridViewPowerFactor.Rows.Clear()
            ChartPowerFactorRec.Series("Series1").Points.Clear()
    ...
    Private Sub CmdBack_Click(sender As Object, e As EventArgs) Handles CmdBack.Click
        DataGridViewPowerFactor.Rows.Clear()
        ChartPowerFactorRec.Series("Series1").Points.Clear()
        ChartPowerFactorRec.Series("Series2").Points.Clear()
        ChartPowerFactorRec.Series("Series3").Points.Clear()
        ChartPowerFactorRec.Series("Series4").Points.Clear()
    ...
    Private Sub CmdExportToExcel_Click(sender As Object, e As EventArgs) Handles CmdExportToExcel.Click
        Try
            If DataGridViewPowerFactor.Rows.Count > 0 Then
                ...
                If result = DialogResult.OK Then
                    ...
                    Dim multiselect As Boolean = DataGridViewPowerFactor.MultiSelect
                    DataGridViewPowerFactor.MultiSelect = True
                    DataGridViewPowerFactor.SelectAll()
                    DataGridViewPowerFactor.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableAlwaysIncludeHeaderText
                    Clipboard.SetDataObject(DataGridViewPowerFactor.GetClipboardContent())
                    Dim results = System.Convert.ToString(Clipboard.GetData(DataFormats.Text))
                    DataGridViewPowerFactor.ClearSelection()
                    DataGridViewPowerFactor.MultiSelect = multiselect
