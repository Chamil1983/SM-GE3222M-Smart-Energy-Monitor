...
Public Class FrmSMGE_3222M_AppntPowerData
    ...
    Private Sub ButtonRecord_Click(sender As Object, e As EventArgs) Handles ButtonRecord.Click
        If ButtonRecord.Text = "Start Recording" Then
            ...
            DataGridViewApperantPower.Rows.Clear()
            ChartApperantPowerRec.Series("Series1").Points.Clear()
    ...
    Private Sub CmdBack_Click(sender As Object, e As EventArgs) Handles CmdBack.Click
        DataGridViewApperantPower.Rows.Clear()
        ChartApperantPowerRec.Series("Series1").Points.Clear()
        ChartApperantPowerRec.Series("Series2").Points.Clear()
        ChartApperantPowerRec.Series("Series3").Points.Clear()
        ChartApperantPowerRec.Series("Series4").Points.Clear()
    ...
    Private Sub CmdExportToExcel_Click(sender As Object, e As EventArgs) Handles CmdExportToExcel.Click
        Try
            If DataGridViewApperantPower.Rows.Count > 0 Then
                ...
                If result = DialogResult.OK Then
                    ...
                    Dim multiselect As Boolean = DataGridViewApperantPower.MultiSelect
                    DataGridViewApperantPower.MultiSelect = True
                    DataGridViewApperantPower.SelectAll()
                    DataGridViewApperantPower.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableAlwaysIncludeHeaderText
                    Clipboard.SetDataObject(DataGridViewApperantPower.GetClipboardContent())
                    Dim results = System.Convert.ToString(Clipboard.GetData(DataFormats.Text))
                    DataGridViewApperantPower.ClearSelection()
                    DataGridViewApperantPower.MultiSelect = multiselect
