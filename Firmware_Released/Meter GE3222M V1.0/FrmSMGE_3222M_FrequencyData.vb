...
Public Class FrmSMGE_3222M_FrequencyData
    ...
    Private Sub ButtonRecord_Click(sender As Object, e As EventArgs) Handles ButtonRecord.Click
        If ButtonRecord.Text = "Start Recording" Then
            ...
            ChartFrequencyRec.Series("Series1").Points.Clear()
    ...
    Private Sub CmdBack_Click(sender As Object, e As EventArgs) Handles CmdBack.Click
        DataGridViewFrequency.Rows.Clear()
        ChartFrequencyRec.Series("Series1").Points.Clear()
        ChartFrequencyRec.Series("Series2").Points.Clear()
        ChartFrequencyRec.Series("Series3").Points.Clear()
        ChartFrequencyRec.Series("Series4").Points.Clear()
    ...
    Private Sub CmdExportToExcel_Click(sender As Object, e As EventArgs) Handles CmdExportToExcel.Click
        Try
            If DataGridViewFrequency.Rows.Count > 0 Then
                ...
                If result = DialogResult.OK Then
                    ...
                    Dim multiselect As Boolean = DataGridViewFrequency.MultiSelect
                    DataGridViewFrequency.MultiSelect = True
                    DataGridViewFrequency.SelectAll()
                    DataGridViewFrequency.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableAlwaysIncludeHeaderText
                    Clipboard.SetDataObject(DataGridViewFrequency.GetClipboardContent())
                    Dim results = System.Convert.ToString(Clipboard.GetData(DataFormats.Text))
                    DataGridViewFrequency.ClearSelection()
                    DataGridViewFrequency.MultiSelect = multiselect
