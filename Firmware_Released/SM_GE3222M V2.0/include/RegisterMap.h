/**
 * @file RegisterMap.h
 * @brief ATM90E32/ATM90E36 Register Map Definitions
 * 
 * This file contains all register address definitions for the ATM90E32 and ATM90E36
 * energy metering ICs. It serves as the single source of truth for register addresses
 * used throughout the SM-GE3222M V2.0 firmware.
 * 
 * Register definitions are organized by functional groups and include conditional
 * compilation blocks for device-specific registers (ATM90E32 vs ATM90E36).
 */
